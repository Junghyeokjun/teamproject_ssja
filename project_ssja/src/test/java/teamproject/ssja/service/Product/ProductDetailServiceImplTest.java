...
class ProductDetailServiceImplTest {
	 ...
	 * @Test void test() {
	 * 
	 * Long productNum = 3081L; ProductDetailTotalInfoDTO data =
	 * ProductService.getProductDetailInfo(productNum);
	 * 
	 * assertNotNull(data);
	 * 
	 * }
	 * 
	 * @Test void 상품상세리뷰테슽트() { Long productNum = 3081L; ListObjectPagingDTO rvdata
	 * = ProductService.getItemsReview(productNum, 1); log.info("data {}", rvdata);
