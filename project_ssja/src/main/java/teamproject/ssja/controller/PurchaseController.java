...
public class PurchaseController {
	...
	public ModelAndView testPurchase(ModelAndView mv) {
		...
		dtos.add(new ProductDto(3899, 1, 11, 11000, 2, "/images/product_banner/product_banner_2.jpg", 4, 2323, 222, "SSJA", "침대"));
		dtos.add(new ProductDto(3900, 1, 12, 12000, 2, "/images/product_banner/product_banner_2.jpg", 4, 2323, 222, "SSJA", "수납"));
		dtos.add(new ProductDto(3901, 1, 13, 21000, 2, "/images/product_banner/product_banner_3.jpg", 4, 2323, 222, "SSJA", "침구"));
