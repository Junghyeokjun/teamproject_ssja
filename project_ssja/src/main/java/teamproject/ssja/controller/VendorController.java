...
//		}
	...
	public String showProductList(@AuthenticationPrincipal CustomPrincipal principal, Model model, Criteria criteria,
		...
		if (principal != null) {
			...
			// model.addAttribute("productpageMaker", new Page10VO(Productstotal,
			// criteria));
			// model.addAttribute("products",
			// productListService.getProductListWithPaging(criteria));
	...
	public String showQnaList(@AuthenticationPrincipal CustomPrincipal principal, Model model, Criteria criteria,
			@PathVariable("category") long bcno) {
		...
		// PageVO(boardService.getTotal(criteria.getBcno()), criteria));
	...
	public String showView(@PathVariable("category") long bcno, HttpServletRequest request,
