...
<body>
    <div class="d-flex align-items-center justify-content-center flex-column my-5">
        <!-- 홈화면링크 -->
        <a id="logo_toHome" href="/home"><img src="/images/utilities/big_logo.png" alt=""></a>
       
      ${userData }
        <!-- 실제 적용시 method post로 변경  -->
        <form action="${pageContext.request.contextPath}/sign-up/regist" method="post" onsubmit="return false" id="sign_up_form">
            <table>
                <tr>
                    <td><p>아이디</p></td>
                    <!-- dto와 name을 맞춰준다. -->
                    <td><input type="text" size="24" id="id" name="M_ID" placeholder="몇자이상의 아이디를 입력해주세요" value="${userData.getM_ID() }" disabled></td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>
                        <!-- 서버에서 둘을 합쳐 이메일로 구분 -->
                        <input type="text" size="8" class="mb-1" id="email" name="M_EMAIL" style="width:100%;" value="${userData.getM_EMAIL() }" disabled> 
                    </td>
                </tr>
                ...
                <tr>
                    <td>이름</td>
                    <td>
                        <input type="text" size="24" class="mb-2" id="name" name="M_NAME" value="${userData.getM_NAME() }" disabled> 
                    </td>
                </tr>
                <tr>
                    <td>전화번호</td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" size="10" class="mb-1" id="detail_address" name="M_ADDRESS2" placeholder="상세주소">
                        <script>
                        $("#detail_address").empty();
                        </script>
                        <input type="text" size="6" class="mb-1" id="extra_address" name="extra_address" value="">
                    </td>
                </tr>
